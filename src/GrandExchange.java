...
import org.powerbot.script.rt6.CacheItemConfig;
...
public class GrandExchange extends ClientAccessor implements MessageListener {
    ...
    public static final int     SALES_HISTORY_WIDGET    = 1638;
    public static final int     SALES_HISTORY_NAMES_COMPONENT = 23;
    public static final int     SALES_HISTORY_PRICES_COMPONENT = 24;
     ...
     *
     * @param id The inventory item to be sold
     ...
     */
    public boolean sell(final int id, final String name, final int amount, final int price) {
        if(!opened() || id == -1)
            return false;
        ...
        if(i == null || !i.click() || !matchesTitle(name))
            return false;
